...
const getCardData = (t: TFunction<"translation", undefined>) => [
    {
        ...
        description: t("cards.location.text"),
    },
    {
        icon: (
            <svg
            ...
            >
                <path
                    d="M56 24L45.3333 13.3334V21.3334H26.6667V26.6667H45.3333V34.6667M18.6667 29.3334L8 40L18.6667 50.6667V42.6667H37.3333V37.3334H18.6667V29.3334Z"
                    fill="#0B0A0A"
                />
            </svg>
        ),
        title: t("cards.exchange.title"),
        description: t("cards.exchange.text"),
    },
    {
        icon: (
            <svg
        ...
        title: t("cards.cardPayment.title"),
        description: t("cards.cardPayment.text"),
    },
    {
        icon: (
            <svg
        ...
        description: t("cards.vehicles.text"),
    },
    {
        icon: (
            <svg
        ...
        description: t("cards.support.text"),
    },
    {
        icon: (
            <svg
            ...
            >
                <path
                    d="M8 56V50.6667L13.3333 45.3333V56H8ZM18.6667 56V40L24 34.6667V56H18.6667ZM29.3333 56V34.6667L34.6667 40.0667V56H29.3333ZM40 56V40.0667L45.3333 34.7333V56H40ZM50.6667 56V29.3333L56 24V56H50.6667ZM8 42.2V34.6667L26.6667 16L37.3333 26.6667L56 8V15.5333L37.3333 34.2L26.6667 23.5333L8 42.2Z"
                    fill="black"
                />
            </svg>
        ),
        title: t("cards.flex.title"),
        description: t("cards.flex.text"),
    },
];
...
const FeatureCards = () => {
    ...
    return (
        <section className="w-full bg-base mx-auto gap-[70px] px-6 md:px-[120px] py-20 flex flex-col items-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 w-full max-w-[1017px]">
                {cardData.map((card, index) => (
                    <Card
                        key={index}
                        className="h-[250px] bg-base rounded-2xl shadow-[6px_7px_25.2px_#00000012] border-none"
                    >
                        <CardContent className="h-full p-[22px] flex flex-col items-center justify-center gap-2">
                            {card.icon}
                            <h3 className="[font-family:'Gilroy-ExtraBold',Helvetica] font-extrabold text-base-black text-[28px] text-center leading-[31.5px]">
                                {card.title}
                            </h3>
                            <p className="[font-family:'Roboto-Regular',Helvetica] font-normal text-base-black text-center leading-[19.2px]">
                                {card.description}
                            </p>
                        </CardContent>
                    </Card>
